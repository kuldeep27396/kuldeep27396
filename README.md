...
📍 **India** | 💼 **Senior Software Engineer @ Walmart**

> Building scalable backend systems, AI-powered solutions, and data platforms.
...
- 🐍 **[telegram-dl](https://github.com/kuldeep27396/telegram-dl)** — Download videos from Telegram | Python, SOLID, Pydantic, 27 Tests
...
- 📱 **[ElderLink](https://github.com/kuldeep27396/ElderLink)** — WhatsApp-first parent health platform | AI insights, reminders
- 🤖 **[pr-review-agent](https://github.com/kuldeep27396/pr-review-agent)** — AI code review agent | LangChain, GPT-4
- 🔮 **[agentic-rag](https://github.com/kuldeep27396/agentic-rag)** — Agentic RAG demo | Streamlit, AI-powered search
- 🛒 **[RealTime-ECommerce-Analytics-Flink](https://github.com/kuldeep27396/RealTime-ECommerce-Analytics-Flink)** — Real-time clickstream analytics | Kafka, Flink, Pinot
- 🌊 **[airflow-projects-deployed](https://github.com/kuldeep27396/airflow-projects-deployed)** — 25+ Production DAGs | Astronomer Cloud
- 🏗️ **[strat-craft-ai-service](https://github.com/kuldeep27396/strat-craft-ai-service)** — AI-powered strategy crafting service
